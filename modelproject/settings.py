...
# SECRET_KEY = "django-insecure-%e^1(p6tbo#+g3a3i9%!s4#lj$9qh0m2^xg8+=l2pgs)6exazg"
...
ALLOWED_HOSTS = ['3.35.62.174', 'verynicetomato.store', '127.0.0.1']
...
SIMPLE_JWT = {
    'ACCESS_TOKEN_LIFETIME': timedelta(days=100), # 이 부분
    'REFRESH_TOKEN_LIFETIME' : timedelta(days=100), # 이 부분
